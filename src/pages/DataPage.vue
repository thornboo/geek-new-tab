...
<template>
  <AppLayout title="Data" active-page="data">
    <div class="content-wrapper max-w-[800px] mx-auto">
      ...
      <div class="space-y-6">
        ...
        <div class="card-base p-5 border-red-900/50">
          <div class="flex items-start gap-4">
            <div
              class="w-10 h-10 rounded border border-red-900/50 bg-red-900/10 flex-center shrink-0"
            >
            ...
            <div class="flex-1">
              ...
              <p class="text-sm text-gray-500 mb-4">
                Remove all custom sites you've added. Default sites will remain. This action cannot
                be undone.
              </p>
              <button
